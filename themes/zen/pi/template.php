 ...
 *   pi_regions()
 * where pi is the name of your sub-theme. For example, the zen_classic
 ...
 * use these functions:
 *   pi_preprocess_page(&$vars)     to add variables to the page.tpl.php
 *   pi_preprocess_node(&$vars)     to add variables to the node.tpl.php
 *   pi_preprocess_comment(&$vars)  to add variables to the comment.tpl.php
 *   pi_preprocess_block(&$vars)    to add variables to the block.tpl.php
 */
...
// drupal_add_css(path_to_theme() .'/html-elements.css', 'theme', 'all'); // commented out TDC
...
drupal_add_css(path_to_subtheme() .'/pi.css', 'theme', 'all');
 ...
 */
/* -- Delete this line if you want to use this function
function pi_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function pi_preprocess_page(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function pi_preprocess_node(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function pi_preprocess_comment(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function pi_preprocess_block(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
