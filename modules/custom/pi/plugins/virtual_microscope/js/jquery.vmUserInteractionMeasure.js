...
(function($) {
  var methods = {
    init: function(options) {
      ...
      var self = this;
      if (options.activeBox) {
        options.activeBox.addClass('virtual_microscope_measure_active_box');
        options.activeBox.customMouseInput('click', function() {
          $(this).vmUserInteractionMeasure('_activeBoxClick', options.startCallback);
        });
      }
    ...
    _activeBoxClick: function(callback) {
      if (callback) {
        callback();
      }
    },
