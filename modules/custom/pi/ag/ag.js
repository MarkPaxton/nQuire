...
$(document).ready(function() {
  ...
  $('#ag_guide a#inquiry-toggle').click(function() {
    $('#ag_guide  #ag_pullout').toggle(400);
    if (pulloutopen == 1) {
      $('#ag_guide img#ag_handle').attr({src:"images/unit-navigator-open.png"});
      pulloutopen = 0;
    }
    else {
      $('#ag_guide img#ag_handle').attr({src:"images/unit-navigator-close.png"});
      pulloutopen = 1;
    };
    return false;
  });
  ...
  function inquiry_rotate_up() {
    ...
    $("#ag_guide div.ag_inquiry:eq(" + current_inquiry + ")").animate({top: -70},"slow");
    $("#ag_guide div.ag_inquiry:eq(" + next_inquiry + ")").show().animate({top: 5},"slow");
  ...
  function inquiry_rotate_down() {
    ...
    $("#ag_guide div.ag_inquiry:eq(" + current_inquiry + ")").animate({top: 80},"slow");
    $("#ag_guide div.ag_inquiry:eq(" + prev_inquiry + ")").show().animate({top: 5},"slow");
